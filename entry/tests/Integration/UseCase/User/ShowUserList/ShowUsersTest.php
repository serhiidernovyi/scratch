...
namespace Tests\Integration\UseCase\User\ShowUserList;
...
class ShowUsersTest extends TestCase
{
     ...
     * @feature User
     * @scenario Show user list
     * @case Successfully show removed user list
     *
     * @test
     */
    public function showUsers_success_deletedSearchCheckResponse()
    {
        // GIVEN
        $this->createUserAndBe();
        $this->createUser('email1@example.com');
        $this->createDeletedUser('email2@example.com');
        $request = $this->createRequest(['deleted_search' => true]);
        $tested_use_case = $this->app->make(UserCase::class);
