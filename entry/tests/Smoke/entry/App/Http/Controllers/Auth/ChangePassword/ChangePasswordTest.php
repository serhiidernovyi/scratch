...
class ChangePasswordTest extends TestCase
{
    ...
    public function changePassword_passwordChanged_response201()
    {
        ...
        $credentials = $this->createCredentials('Password1', 'Password2', 'Password2');
     ...
     * @feature Auth
     * @scenario Change Password
     * @case Failed change password
     *
     * @dataProvider badRequests422
     *
     * @param array $request
     * @test
     */
    public function changePassword_notWalidData_response422($request)
    {
        // GIVEN
        $this->createUserAndBe('email@example.com');
