...
namespace Tests\Smoke\entry\App\Http\Controllers\User\Show;
...
class ShowTest extends TestCase
{
     ...
     * @test
     */
    public function showUser_noAccess_responseForbidden()
    {
        // GIVEN
        $user = $this->createUserAndBe('admin@example.com', 'DRIVER');
